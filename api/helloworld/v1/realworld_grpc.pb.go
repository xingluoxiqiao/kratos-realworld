...
const (
	RealWorld_Login_FullMethodName             = "/helloworld.v1.RealWorld/Login"
	RealWorld_Register_FullMethodName          = "/helloworld.v1.RealWorld/Register"
	RealWorld_GetCurrentUser_FullMethodName    = "/helloworld.v1.RealWorld/GetCurrentUser"
	RealWorld_UpdateUser_FullMethodName        = "/helloworld.v1.RealWorld/UpdateUser"
	RealWorld_GetProfile_FullMethodName        = "/helloworld.v1.RealWorld/GetProfile"
	RealWorld_FollowUser_FullMethodName        = "/helloworld.v1.RealWorld/FollowUser"
	RealWorld_UnFollowUser_FullMethodName      = "/helloworld.v1.RealWorld/UnFollowUser"
	RealWorld_ListArticles_FullMethodName      = "/helloworld.v1.RealWorld/ListArticles"
	RealWorld_FeedArticles_FullMethodName      = "/helloworld.v1.RealWorld/FeedArticles"
	RealWorld_GetArticle_FullMethodName        = "/helloworld.v1.RealWorld/GetArticle"
	RealWorld_CreateArticle_FullMethodName     = "/helloworld.v1.RealWorld/CreateArticle"
	RealWorld_UpdateArticle_FullMethodName     = "/helloworld.v1.RealWorld/UpdateArticle"
	RealWorld_DeleteArticle_FullMethodName     = "/helloworld.v1.RealWorld/DeleteArticle"
	RealWorld_AddComment_FullMethodName        = "/helloworld.v1.RealWorld/AddComment"
	RealWorld_GetComments_FullMethodName       = "/helloworld.v1.RealWorld/GetComments"
	RealWorld_DeleteComment_FullMethodName     = "/helloworld.v1.RealWorld/deleteComment"
	RealWorld_FavoriteArticle_FullMethodName   = "/helloworld.v1.RealWorld/FavoriteArticle"
	RealWorld_UnFavoriteArticle_FullMethodName = "/helloworld.v1.RealWorld/UnFavoriteArticle"
	RealWorld_GetTags_FullMethodName           = "/helloworld.v1.RealWorld/GetTags"
)
...
type RealWorldClient interface {
	...
	UnFavoriteArticle(ctx context.Context, in *UnFavoriteArticleRequest, opts ...grpc.CallOption) (*SingleCommentReply, error)
...
func (c *realWorldClient) UnFavoriteArticle(ctx context.Context, in *UnFavoriteArticleRequest, opts ...grpc.CallOption) (*SingleCommentReply, error) {
	out := new(SingleCommentReply)
...
type RealWorldServer interface {
	...
	UnFavoriteArticle(context.Context, *UnFavoriteArticleRequest) (*SingleCommentReply, error)
...
func (UnimplementedRealWorldServer) UnFavoriteArticle(context.Context, *UnFavoriteArticleRequest) (*SingleCommentReply, error) {
